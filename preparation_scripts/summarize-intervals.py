...
out_df = df[['gameid', 'playid','home_score','away_score','home_possessions','away_possessions','time_interval','home_possessions_this_interval','away_possessions_this_interval','home_score_this_interval','away_score_this_interval']]
#write updated df to pbp_with_interval_stats.db
out_df.to_sql('pbp', with_interval_stats, if_exists='replace', index=False)
